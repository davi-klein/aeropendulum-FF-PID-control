...
* **Single Source of Truth:** All mechanical, aerodynamic, and actuator parameters are decoupled from the Simulink blocks and encapsulated within a single structural data model (`init_aeropendulum_params.m`).
...
│   └── init_aeropendulum_params.m  # Encapsulated physical data model
├── aeropendulum_dynamics.slx   # Simulink model (Plant + Controller)
